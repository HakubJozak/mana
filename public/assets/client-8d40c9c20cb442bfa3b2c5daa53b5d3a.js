...
(function() {
  ...
  CardView = (function() {
    ...
    CardView.prototype._render_overlay = function() {
      if (this.model.counters()) {
        this.$('.counters').fadeIn().text(this.model.counters());
      }
      if (this.model.toughness() || this.model.power()) {
...
(function() {
  ...
  CardViewDropbox = (function() {
    ...
    CardViewDropbox.prototype.clicked = function() {};
...
(function() {
  ...
  UserView = (function() {
    ...
    UserView.prototype.deck_dropped = function(event, ui) {
      ...
      if (confirm("Do you really want to show cards in your " + deck.name + " to " + (this.model.name()))) {
