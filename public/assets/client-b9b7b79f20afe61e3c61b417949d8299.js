...
(function() {
  ...
  Chat = (function() {
    __extends(Chat, Backbone.Collection);
    function Chat() {
      this.message_arrived = __bind(this.message_arrived, this);
      Chat.__super__.constructor.apply(this, arguments);
    }
    Chat.prototype.model = Message;
    Chat.prototype.message_arrived = function(msg) {
      return this.add(msg);
    };
    return Chat;
  })();
  ...
  Controls = (function() {
    ...
    Controls.prototype.input = function(e) {
      ...
      switch (c = String.fromCharCode(e.keyCode)) {
        ...
        default:
          if (c === ' ') {
            return this.trigger('key:spacebar');
          }
      }
    };
...
(function() {
  ...
  ChatView = (function() {
    ...
    function ChatView() {
      this.close_or_submit = __bind(this.close_or_submit, this);
      ChatView.__super__.constructor.apply(this, arguments);
    }
    ChatView.prototype.initialize = function() {
      this.el = $('#chat-bar');
      return this.el.draggable().keyup(this.close_or_submit).children('input').blur();
    };
    ChatView.prototype.close_or_submit = function(event) {
      if (event.keyCode === 27) {
    ...
    ChatView.prototype.close_chat = function() {
      return this.el.hide().children('input').blur();
    };
    ChatView.prototype.submit_chat = function() {
      var input, message;
