  ...
  Controls = (function() {
    ...
    Controls.prototype.input = function(e) {
      ...
      switch (c = String.fromCharCode(e.keyCode)) {
        ...
        default:
          if (c === ' ') {
            this.trigger('key:spacebar');
          }
          if (c === 'm') {
            return this.trigger('key:m');
          }
      }
    };
...
(function() {
  ...
  CardView = (function() {
    ...
    function CardView(params) {
      ...
      this.add_menu_item('bottom-button', 'Bottom', 'Put the card to the bottom of your library');
      this.$('.bottom-button').click(__bind(function() {
    ...
    CardView.prototype.add_menu_item = function(clazz, name, title) {
      var item;
...
(function() {
  ...
  BattlefieldView = (function() {
    ...
    BattlefieldView.tagName = 'div';
    BattlefieldView.className = 'battlefield';
    function BattlefieldView(attrs) {
      this.to_relative = __bind(this.to_relative, this);
      this.to_global = __bind(this.to_global, this);
      this.dropped = __bind(this.dropped, this);
      this.sort = __bind(this.sort, this);
      this.append_card_view = __bind(this.append_card_view, this);
      this.create_card_view = __bind(this.create_card_view, this);      BattlefieldView.__super__.constructor.call(this, attrs);
      this.el = $('#battlefield');
      this.el.droppable({
        scope: 'cards',
    ...
    BattlefieldView.prototype.dropped = function(event, ui) {
      ...
      old = card.collection;
      card.set({
        position: this.to_relative(p)
      }, {
        silent: true
      });
      if (old.id !== this.model.id) {
        old.remove(card);
        this.model.add(card);
      }
      return card.save();
    };
    BattlefieldView.prototype.to_global = function(p) {
      var origin;
      origin = this.el.offset();
      return {
        top: p.y + this.el.offset().top,
        left: p.x + this.el.offset().left
      };
    };
    BattlefieldView.prototype.to_relative = function(p) {
      var left, origin, top;
      origin = this.el.offset();
  ...
  CardViewBattlefield = (function() {
    ...
    function CardViewBattlefield(params) {
      ...
      this.add_menu_item('transform-button', 'Transform', 'Transform card (r)');
      this.add_menu_item('detail-button', 'Detail', 'Show detail of the card');
      this.add_menu_item('cover-button', 'Un|cover', 'Cover/Uncover the card (u)');
      this.$('.transform-button').click(__bind(function() {
        return this.model.transform();
      }, this));
      this.$('.cover-button').click(__bind(function() {
        return this.model.toggle_covered();
      }, this));
      this.$('.detail-button').click(__bind(function() {
...
(function() {
  ...
  CardViewBrowser = (function() {
    ...
    function CardViewBrowser(params) {
      ...
      this.add_menu_item('to-hand-button', 'Hand', 'Put the card to your hand');
      this.$('.to-hand-button').click(__bind(function() {
...
(function() {
  ...
  ChatView = (function() {
    ...
    ChatView.prototype.initialize = function() {
      ...
      return Controls.current.bind('key:m', this.focus);
    };
    ChatView.prototype.focus = function() {
      var input;
      return input = this.$('.chat-input').focus();
    };
