...
(function() {
  $(document).ready(function() {
    $('#color-picker').farbtastic(function(color, second) {
      return $('#player_color').css('color', color).val(color);
    });
    $('#player_color').click(function() {
      return $('#color-picker').fadeIn();
    });
    $('#player_color').focus(function() {
      return $('#color-picker').fadeIn();
    });
    return $('#player_color').blur(function() {
