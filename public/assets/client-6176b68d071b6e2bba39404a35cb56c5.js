    ...
    function CardView(params) {
      ...
      this.el.draggable({
        ...
        start: __bind(function() {
          return $('.overlay').trigger('mouseleave');
        }, this)
      });
      this.el.bind('click', this.clicked);
      this.el.bind('contextmenu', this.clicked);
      this.el.data('game-object', this);
      this.element = this.el;
    }
    CardView.prototype.clicked = function(e) {
      e.preventDefault();
      e.stopPropagation();
      if (e.button === 2) {
    ...
    CardDetailView.prototype.on_animation_end = function() {
      return this.$('img').click(__bind(function(e) {
        if (this.ignore_click) {
          ...
          this.el.fadeOut(__bind(function() {
  ...
  CardCollectionView = (function() {
    ...
    CardCollectionView.prototype.sort = function() {
      ...
      return _(this.views).each(__bind(function(view) {
        view.el.detach();
        this.append_card_view(view);
        return view.el.css('z-index', view.model.order());
      }, this));
    };
    ...
    CardCollectionView.prototype.dropped = function(event, ui) {
      ...
      card.collection.remove(card);
      order = this.model.last() ? this.model.last().order() + 10 : 1;
      card.set({
        order: order
      }, {
        silent: true
...
(function() {
  ...
  CardBrowser = (function() {
    ...
    CardBrowser.show_or_hide = function(model) {
      var all;
      all = CardBrowser.all;
      if (all[model.id] != null) {
        return all[model.id].remove();
      } else {
        return all[model.id] = new CardBrowser({
          model: model
        });
      }
    };
    function CardBrowser(params) {
      ...
      this.$('.close-button').click(__bind(function() {
        return this.remove();
      }, this));
    ...
    CardBrowser.prototype.remove = function() {
      var after;
      after = __bind(function() {
        this.model.unbind('add', this.add_card_view);
        this.model.unbind('remove', this.remove_card_view);
        this.model.unbind('change', this.render);
        this.el.remove();
        return CardBrowser.all[this.model.id] = null;
      }, this);
      return this.el.fadeOut('200', after);
    };
    CardBrowser.prototype.create_card_view = function(card) {
      return new CardViewBrowser({
        model: card
      });
    };
  ...
  CardViewBrowser = (function() {
    ...
    function CardViewBrowser() {
      this.show_tapping = __bind(this.show_tapping, this);
      this.show_image = __bind(this.show_image, this);
      CardViewBrowser.__super__.constructor.apply(this, arguments);
    }
...
(function() {
  ...
  CardViewDropbox = (function() {
    ...
    CardViewDropbox.prototype.clicked = function(e) {
      e.preventDefault();
      e.stopPropagation();
      if (e.button !== 2) {
...
(function() {
  ...
  HandView = (function() {
      ...
      create_or_close = function() {
        if (HandView.current != null) {
          ...
          if (HandView.last_position) {
            return HandView.current.el.offset(HandView.last_position);
          }
        }
      };
    ...
    function HandView(attrs) {
      this.mulligan = __bind(this.mulligan, this);
      this.render = __bind(this.render, this);
      this.dropped_and_turned = __bind(this.dropped_and_turned, this);
      this.append_card_view = __bind(this.append_card_view, this);
      this.create_card_view = __bind(this.create_card_view, this);
    ...
    HandView.prototype.dropped_and_turned = function(event, ui) {
      var card;
      card = ui.draggable.ob().model;
      card.collection.remove(card);
      this.model.add(card);
