...
(function() {
  ...
  CardView = (function() {
    ...
    CardView.BACK_SIDE = "/images/back.jpg";
    ...
    CardView.prototype.show_image = function() {
      if (this.model.covered()) {
        return this.img.attr('src', '/assets/back.jpg');
      } else {
...
(function() {
  ...
  CardBrowser = (function() {
    ...
    function CardBrowser(params) {
      ...
      this.$('.uncover-button').click(__bind(function() {
        return this.model.each(function(card) {
          return card.toggle_covered(false, {
            save: false
          });
        });
      }, this));
      this.$('.cover-button').click(__bind(function() {
        return this.model.each(function(card) {
          return card.toggle_covered(true, {
            save: false
          });
        });
      }, this));
