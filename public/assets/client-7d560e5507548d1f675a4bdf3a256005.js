...
(function() {
  ...
  Game = (function() {
    ...
    function Game() {
      this.create_card = __bind(this.create_card, this);
    ...
    Game.prototype.create_card = function(image_url) {
      ...
      return $('#battlefield').ob().dropped(view);
    };
    return Game;
  })();
  window.Game = Game;
  ...
  CardView = (function() {
    ...
    CardView.prototype.show_detail = function() {
      ...
      if (!this.model.covered()) {
        ...
        return img.clone().addClass('detail').css('position', 'absolute').css('top', pos.top).css('left', pos.left).appendTo('body').animate({
          width: "" + w + "px",
          height: "" + h + "px",
          top: "" + (pos.top - 50) + "px",
          left: "" + (pos.left - 50) + "px"
