...
(function() {
  ...
  CardCollectionView = (function() {
    ...
    function CardCollectionView(attrs) {
      ...
      CardCollectionView.all[this.model.id] = this;
      ...
      this.model.bind('change', this.sort);
    }
    ...
    CardCollectionView.prototype.sort = function() {
      ...
      return _(this.views).each(__bind(function(view) {
        view.el.detach();
        return this.append_card_view(view);
      }, this));
    };
    ...
    CardCollectionView.prototype.dropped = function(event, ui) {
      ...
      card.collection.remove(card);
      order = this.model.last() ? this.model.last().order() + 1 : 1;
      card.set({
        order: order
      }, {
        silent: true
...
(function() {
  ...
  Dropbox = (function() {
    ...
    function Dropbox(attrs) {
      this.append_card_view = __bind(this.append_card_view, this);
      this.create_card_view = __bind(this.create_card_view, this);      Dropbox.__super__.constructor.call(this, attrs);
      this.box = this.$('.box');
      ...
      this.render();
      this.box.mouseenter(__bind(function() {
        return this.$('.overlay').fadeIn();
      }, this));
      this.box.mouseleave(__bind(function() {
      ...
      this.$('.shuffle-button').click(__bind(function() {
        new Message({
          text: "Player " + (User.local.name()) + " has shuffled " + this.model.long_title + "."
        });
        return this.model.shuffle_cards();
      }, this));
    }
